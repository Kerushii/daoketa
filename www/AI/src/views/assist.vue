...
<template>
  <div style="position: absolute;height: 90vh;width: 163vh;right: 3vw;background: #ffffff00;top: 5vh;">
    ...
    <div class="menuEntryOff" v-if="menuEntry != 'sys'" style="position:absolute;top:-6.1%;background: rgb(100 100 100);width:9%;height:7.1%;filter:drop-shadow(rgba(0, 0, 0, 0.3) 14px 11px 4px);left: 18%;overflow:hidden;" @click="setMenuEntry('sys')">
      <div style="position:absolute;top:19%;right: 16%;font-family:font2;filter:drop-shadow(rgba(0, 0, 0, 0.6) 10px 9px 4px);">SYSTEM</div>
    ...
    <div class="menuEntryOn" v-if="menuEntry == 'sys'" style="position:absolute;top:-6.1%;background:rgba(255, 253, 253, 0.77);width:9%;height:7.1%;filter:drop-shadow(rgba(255, 255, 255, 0.3) 14px 11px 4px);left:18%;overflow:hidden;">
      <div style="position:absolute;top:19%;left:46%;font-family:font2;filter:drop-shadow(rgba(0, 0, 0, 0.6) 10px 9px 4px);">SYSTEM</div>
      <div style="position:absolute;top:49%;left:30%;font-family:font5;text-align:right;width:54%;font-size:0.7vh;filter:drop-shadow(rgba(0, 0, 0, 0.6) 10px 9px 4px);">SELECT MODELS FOR THE BEST PERFORMANCE</div><img src="/network-wired-solid.svg" style="position:absolute;bottom:16%;left:-3%;height:64%;opacity:0.05;">
    </div>
    <div class="menuEntrySubOpt" v-if="menuEntry == 'model'" style="position:absolute;top:1%;background:rgb(255 253 253 / 44%);width:100%;height:2%;filter:drop-shadow(rgba(255, 255, 255, 0.3) 14px 11px 4px);left:0%;">
      <div v-if="aiType != 'pubmedGPT'" style="position:absolute;height:100%;width:13%;/* background:#2196f3; */color: #7c7c7c;padding-right:0.4%;text-align:right;padding-top:1%;top: -68%;font-family:font10;filter:drop-shadow(#2196f352 14px 12px 11px);" @click="setAIType('pubmedGPT')">PUBMEDGPT</div>
      <div v-if="aiType == 'pubmedGPT'" style="position:absolute;height:100%;width:13%;background:#2196f3;color:white;padding-right:0.4%;text-align:right;padding-top:1%;top:-26%;font-family:font10;filter:drop-shadow(#2196f352 14px 12px 11px);">PUBMEDGPT</div>
    ...
    <div class="menuEntrySubOpt" v-if="menuEntry == 'sys'" style="position:absolute;top:1%;background:rgb(255 253 253 / 44%);width:100%;height:2%;filter:drop-shadow(rgba(255, 255, 255, 0.3) 14px 11px 4px);left:0%;">
      <div v-if="!priming" style="position:absolute;height:100%;width:13%;/* background:#2196f3; */color: #7c7c7c;padding-right:0.4%;text-align:right;padding-top:1%;top: -68%;font-family:font10;filter:drop-shadow(#2196f352 14px 12px 11px);" @click="setPrime(true)">PRIMING</div>
      <div v-if="priming" style="position:absolute;height:100%;width:13%;background:#2196f3;color:white;padding-right:0.4%;text-align:right;padding-top:1%;top:-26%;font-family:font10;filter:drop-shadow(#2196f352 14px 12px 11px); " @click="setPrime(false)">PRIMING</div>
    </div>
